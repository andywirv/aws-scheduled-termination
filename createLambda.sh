...
aws lambda create-function --function-name=$lamda_function_name --runtime=nodejs4.3 --timeout 30 --role=$iam_role --handler=index.handler --zip-file=fileb://$zip_file_path
